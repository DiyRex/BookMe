                        ...
                        <tbody>
                            ...
                            foreach ($properties as $property) {
                                ...
                                if($Pstatus === "Pending"){
                                    ...
                                    $acceptBtn = "<a href='/acceptProperty?id=$propID' class='btn btn-success btn-sm text-white mx-2' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Accept Property'><i class='fa-solid fa-check'></i></a>";
                                ...
                                <td>" . $status . "</td>
                                <td class='d-flex'>". $acceptBtn . $deletebtn . "</td>
                                </tr>
                                ";
                            }
                            ?>
