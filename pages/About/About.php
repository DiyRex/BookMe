        ...
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
                <div class="col-12 col-lg-6 col-xl-5">
                    <img class="img-fluid rounded" loading="lazy" src="../../assets/banner.png" alt="">
                </div>
                    ...
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            ...
                            <p class="mb-5">We are a passionate team of second-year students from NSBM Green University, united by a shared vision to streamline the process of finding boarding places for students and assisting landlords in renting out their properties with ease and responsibility. Born from our own experiences and the challenges we've witnessed among peers, our website serves as a bridge connecting students in search of comfortable, secure, and convenient accommodations with property owners looking to rent their spaces to trustworthy tenants.
                                ...
                                Our commitment goes beyond mere transactions; we strive to foster a community built on trust, respect, and mutual benefit. By carefully vetting listings and facilitating clear, direct communication between parties, we aspire to create a secure and supportive environment for all users. At the heart of our mission is the belief that finding the right boarding place or tenant should be straightforward and hassle-free. Through our platform, we're excited to contribute to a smoother, more enjoyable university experience for students and a more rewarding rental experience for landlords..</p>
                        </div>
                    </div>
                </div>
            </div>
